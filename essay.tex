...
\section{DNF中的装备收集问题2}
  ...
  可能集P (Possible): 对于目标集$T$, 它的可能集$P=flatten(\{G_{k_1}, G_{k_2}, \dots, G_{k_n} | G_{k_i} \in C_i, i = 1,\dots,|T|\})$
  ...
  在我们的问题中, 若记已收集集合为S, 事件$A_i = S \subset P_i$, 目标集$T$的可能集为$P_1,\dots,P_n$, 则当获得m件装备时完成收集目标的概率为
  \begin{equation*}
    \begin{split}
      & P(\bigcup_{i=1}^n A_i) \\
